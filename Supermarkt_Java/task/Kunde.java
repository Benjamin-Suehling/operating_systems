	...
	public void run() {
		try {
			...
			for (int i = 0; i < 5; i++) { //Kunde kauft insgesamt 5 Artikel ein
				Thread.sleep(random.nextInt(500) + 100); // Kunde ueberlegt, wo der naechste Artikel ist
				...
				Thread.sleep(random.nextInt(250) + 50); // Kunde nimmt benoetigten Artikel aus dem Regal
